...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-[100svh] w-full bg-slate-950 overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(75%_60%_at_50%_40%,rgba(56,189,248,0.15),transparent_60%)]" aria-hidden />
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full border border-cyan-400/20 bg-slate-900/30 px-4 py-2 backdrop-blur-md">
              ...
              <span className="text-xs tracking-wider text-cyan-200/80">Human-first • Results-driven • AI-native</span>
            </div>
            ...
            <h1 className="mt-6 text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-white drop-shadow-[0_2px_20px_rgba(8,145,178,0.25)]">
              We build helpful AI systems and fast websites that grow real businesses
            </h1>

            <p className="mt-4 text-base md:text-lg text-cyan-100/90 max-w-2xl">
              No hype—just practical automation, chat and voice assistants, and clean web experiences. Talk to a human, ship quickly, and measure what matters.
            </p>
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-slate-950 to-transparent" aria-hidden />
    </section>
  )
}
